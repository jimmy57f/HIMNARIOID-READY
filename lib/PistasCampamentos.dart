...
class Pistascampamentos extends StatefulWidget {
  @override
  _PistascampamentosState createState() => _PistascampamentosState();
}

class _PistascampamentosState extends State<Pistascampamentos>
  ...
  Future<void> _loadMusicFiles() async {
    try {
      final ListResult result = await _storage.ref('musica/campamentos').listAll();
      setState(() {
  ...
  Future<File> _downloadFile(String fileName) async {
    final ref = _storage.ref('musica/campamentos/$fileName');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Himnos Juveniles'),
